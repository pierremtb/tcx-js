...
(function() {
  ...
  Parser = (function() {
    ...
    function Parser(opts) {
      ...
      this.parse_file = bind(this.parse_file, this);
      this.options = opts;
        ...
        return function(name) {
          ...
          switch (p) {
            ...
            case "Activities|Activity|Lap|Track|Trackpoint|Extensions|TPX|RunCadence":
              ...
              break;
            case "Activities|Activity|Lap|Track|Trackpoint|Cadence":
              _this.curr_tkpt.bike_cadence = _this.curr_text;
              break;
            case "Activities|Activity|Lap|Track|Trackpoint|Extensions|TPX|Watts":
              _this.curr_tkpt.bike_power = _this.curr_text;
              break;
            case "Activities|Activity|Lap|Track|Trackpoint|Extensions|TPX|Speed":
              _this.curr_tkpt.speed = parseInt(_this.curr_text)*Parser.3.6;
              break;
    ...
    Parser.prototype.finish = function() {
      var altm, distm, dt, et, i, idx, len, ref, results, sec, tkpt;
      ...
      for (idx = i = 0, len = ref.length; i < len; idx = ++i) {
        ...
        if (this.options.elapsed === true) {
          if (this.tkpt0_time) {
            ...
            results.push(tkpt.elapsed_hhmmss = et.as_hhmmss());
          } else {
            results.push(void 0);
          }
        } else {
